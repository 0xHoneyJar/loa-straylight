 ...
 * frontier cutover — enabled: false on BOTH sides, exactly one new epoch, and a
 * valid durable event frontier whose global maximum the new boundary is strictly
 * after. Independent of the runtime accepted-epoch lock: it takes the previous
